...
namespace StudentList_While
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int[] ages = new int[studenCount];
            string[] names = new string[studenCount];
            double[] heights = new double[studenCount];

            for (int studentNumber = 0; studentNumber < studenCount; studentNumber++)
            {
